class Knapsack {
    ...
    int solveRecursion(int W, int n) {
        if (W == 0 || n == 0)
            ...
            return Math.max(solveRecursion(W, n - 1), val[n - 1] + solveRecursion(W - wt[n - 1], n - 1));
    }
    ...
    int solveMemRecursion(int W, int n) {
        ...
        if (W == 0 || n == 0)
            ...
            result = Math.max(solveMemRecursion(W, n - 1), val[n - 1] + solveMemRecursion(W - wt[n - 1], n - 1));
